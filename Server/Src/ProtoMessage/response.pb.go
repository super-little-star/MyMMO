...
var file_response_proto_rawDesc = []byte{
	...
	0x04, 0x75, 0x73, 0x65, 0x72, 0x42, 0x2c, 0x5a, 0x1b, 0x2e, 0x2f, 0x50, 0x72, 0x6f, 0x74, 0x6f,
	0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x3b, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x4d, 0x65, 0x73,
...
var file_response_proto_goTypes = []interface{}{
	...
	(RESULT)(0),              // 2: ProtoMessage.RESULT
	(Error)(0),               // 3: ProtoMessage.Error
	(*PUser)(nil),            // 4: ProtoMessage.PUser
}
var file_response_proto_depIdxs = []int32{
	2, // 0: ProtoMessage.RegisterResponse.result:type_name -> ProtoMessage.RESULT
	3, // 1: ProtoMessage.RegisterResponse.error:type_name -> ProtoMessage.Error
	2, // 2: ProtoMessage.LoginResponse.result:type_name -> ProtoMessage.RESULT
	3, // 3: ProtoMessage.LoginResponse.error:type_name -> ProtoMessage.Error
	4, // 4: ProtoMessage.LoginResponse.user:type_name -> ProtoMessage.PUser
